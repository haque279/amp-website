<footer class="clearfix">
    <div class="p3 clearfix" style="background: #F1B500">
        <div class="px3 center">
            <h2 style="color: #fff">sign up with email <br>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut distinctio dolorum quo, architecto provident, impedit sit excepturi tempore ipsam iste magnam officiis dolores, eaque quisquam magni, non culpa unde nisi.
            </h2>
            <input type="text" placeholder="Your Email" class="p2 m1" style="  padding: 12px; background: #ddd; border: 1px solid #0984e3">
            <a href="offer.html" class="btn m1">Subscribe</a>
        </div>
    </div>
    <div class="center">
        <div class=" sm-col-12">
            <div class="p3">
                ...
                <div class="">
                    <ul class="footer_menu clearfix center">
                        <li><a href="privacy-policy.php">Privacy Policy</a></li>
                        <li><a href="terms-of-service.php">Terms of Service</a></li>
                    </ul>
                </div>
                <p>
                    © Copywrite 2018 | All Right Reserved by Test Digital Media.
                </p>
